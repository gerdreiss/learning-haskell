...
main = do
    ...
    -- If we don't have the right amount of rights, give an error and abort
...
findByUID content uid =
    let al = map parseline . filter (notElem '#') . lines $ content
        in lookup uid al
...
-- Takes a delimieter and a list. Break up the list based on the delimiter
split :: Eq a => a -> [a] -> [[a]]
